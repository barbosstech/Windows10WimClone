...
@rem    Script de clone de imagem generica do Windows 10 2H21.
...
dism /Apply-Image /ImageFile:"D:\Imagens\PRIOSysPrep.wim" /Index:1 /ApplyDir:W:\
...
xcopy /h D:\Imagens\PRIOSysPrep.wim R:\Recovery\WindowsRE\
